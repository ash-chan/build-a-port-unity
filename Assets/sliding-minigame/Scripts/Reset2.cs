...
public class Reset2 : MonoBehaviour {
    ...
    public void OnMouseDown()
    {
        ...
        Instantiate(Target, new Vector3(-1f, 0.5f, 0.5f), Target.rotation);
        Instantiate(V3, new Vector3(-2.5f, 0.5f, 1.5f), V3.rotation);
        Instantiate(V3, new Vector3(0.5f, 0.5f, 1.5f), V3.rotation);
        Instantiate(V2, new Vector3(-0.5f, 0.5f, -1f), H2.rotation);
        Instantiate(V2, new Vector3(2.5f, 0.5f, -2f), H2.rotation);
        Instantiate(H3, new Vector3(1.5f, 0.5f, -0.5f), H3.rotation);
        Instantiate(H3, new Vector3(0.5f, 0.5f, -2.5f), H3.rotation);
    }
}